package com.karacce.beetle.data.remote

import com.karacce.beetle.data.Label
import com.karacce.beetle.data.User
import com.karacce.beetle.data.remote.azure.WorkItemComposer
import com.karacce.beetle.data.remote.github.IssueRequest
...
data class Result(
    ...
    fun gitlabIssue(): com.karacce.beetle.data.remote.gitlab.IssueRequest {

        return com.karacce.beetle.data.remote.gitlab.IssueRequest(
            title,
